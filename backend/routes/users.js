        ...
        .then((result) => {
            ...
            if (fetchUser.verified === true) {
              ...
              Settings.find().then(document => {
                ...
                } else if (fetchUser.user_type === 'User' && settings.userCanLogin == false) {
                  res.status(200).json({
                    message: 'User Cannot Login'
                  });
                } else if (fetchUser.user_type === 'User' && settings.userCanLogin == true) {
                  res.status(200).json({
                    token: token,
                    expiresIn: 3600,
                    userId: fetchUser._id,
              ...
              //     role: fetchUser.user_type
              //   });
              // } else if (fetchUser.user_type === 'User' && )
...
router.post('/members', checkAuth, upload.single('profile_pic'), (req, res, next) => {
                             ...
                             <table width="100%" cellspacing="0" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                               <tr style="border-collapse:collapse"> 
                                <td align="left" style="padding:0;Margin:0;width:518px"> 
                                 <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                                   <tr style="border-collapse:collapse"> 
                                    <td class="es-m-txt-c" align="center" style="padding:0;Margin:0"><h2 style="Margin:0;line-height:34px;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-size:28px;font-style:normal;font-weight:normal;color:#474745">Hey, ${req.body.first_name} ${ req.body.last_name }!</h2></td> 
                                   </tr>
                                   
                                   <tr style="border-collapse:collapse"> 
                                    <td class="es-m-txt-c" align="center" style="padding:0;Margin:0"><h2 style="Margin:0;line-height:34px;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-size:28px;font-style:normal;font-weight:normal;color:#474745">Your Mail Id, ${req.body.email_id}!</h2></td> 
                                   </tr>


                                   <tr style="border-collapse:collapse"> 
                                    <td class="es-m-txt-c" align="center" style="padding:0;Margin:0"><h2 style="Margin:0;line-height:34px;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-size:28px;font-style:normal;font-weight:normal;color:#474745">Your Password, ${ password }!</h2></td> 
                                   </tr>
...
router.get('/members', checkAuth, (req, res, next) => {
